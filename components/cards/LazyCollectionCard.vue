<template>
  <div ref="card" tabindex="0" :id="`collection-card-${index}`" :style="{ width: width + 'px', height: height + 'px' }" class="rounded-sm cursor-pointer z-30" @click="clickCard" @keydown.enter="clickCard">
